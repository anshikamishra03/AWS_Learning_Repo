Step 1: Preparation- Converting monolithic application to microservices b'coz it will be very easy to deploy one microservice asa a container on kubernetes cluster.
